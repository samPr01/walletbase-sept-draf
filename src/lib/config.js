...
export const RECEIVING_ADDRESSES = {
  ...
  USDT: process.env.NEXT_PUBLIC_USDT_ADDRESS || '0x742d35Cc6635C0532925a3b8D4C9db96D4c9d123',
  ETH: process.env.NEXT_PUBLIC_ETH_ADDRESS || '0x742d35Cc6635C0532925a3b8D4C9db96D4c9d123',
};

// WalletConnect Configuration
export const WALLETCONNECT_CONFIG = {
  PROJECT_ID: process.env.NEXT_PUBLIC_PROJECT_ID || 'your_walletconnect_project_id_here'
};
